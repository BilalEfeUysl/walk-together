...
-- ==================================================
-- EKSİK KAYITLARI TAMAMLAMA PAKETİ (10+ KURALI İÇİN)
-- ==================================================

-- 1. EKSİK KATEGORİLER
INSERT INTO categories (category_name, icon_url) VALUES
('Kanyon Geçişi', 'canyon.png'), ('Kuş Gözlemi', 'bird.png'), 
('Fotoğraf Safarisi', 'camera.png'), ('Yıldız İzleme', 'star.png');
...
-- 3. EKSİK KULÜP ÜYELİKLERİ
INSERT INTO club_members (club_id, user_id, role) VALUES
(2, 1, 'member'), (2, 8, 'member'), (3, 2, 'member'), (3, 10, 'member');

-- 4. EKSİK DUYURULAR (HİÇ YOKTU)
...
-- 7. EKSİK YORUMLAR (ROUTE_REVIEWS)
INSERT INTO route_reviews (route_id, user_id, comment, rating) VALUES
...
-- 8. EKSİK ROZETLER
INSERT INTO badges (badge_name, description, badge_type, required_value) VALUES
('Sosyal Kelebek', '10 arkadaşa ulaştı.', 'User', 10),
('Gece Kuşu', 'Gece etkinliğine katıldı.', 'User', 0),
('Lider Ruh', 'Bir kulüp kurdu.', 'User', 0);